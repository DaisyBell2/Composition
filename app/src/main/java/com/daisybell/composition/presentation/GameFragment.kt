...
import com.daisybell.composition.databinding.FragmentGameBinding
...
class GameFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val gameSettings = GameSettings(15, 15, 50, 7)
        val gameResult = GameResult(true, 20, 25, gameSettings)
        binding.tvSum.setOnClickListener { launchGameFinishedFragment(gameResult) }
    }
